...
export OPENCHS_SERVER_OPTS="-Dnewrelic.environment=${environment} -javaagent:/opt/newrelic/newrelic.jar -Dlogging.file=/var/log/openchs/chs.log -Dlogging.path=/var/log/openchs/ -Dlogging.file.max-size=5mb -Xmx250m -XX:+HeapDumpOnOutOfMemoryError -XX:ErrorFile=/var/log/openchs/jvm.log"
