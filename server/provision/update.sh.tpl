...
sudo yum -y install https://${minor_version}-64591222-gh.circle-artifacts.com/0/~/home/circleci/artifacts/openchs-server-${major_version}-${minor_version}.noarch.rpm 2>&1 >/dev/null
